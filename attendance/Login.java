...
public class Login{
	...
	public void loginView() {
		...
		attendance.setForeground(Color.decode("#379683"));
		...
		management.setForeground(Color.decode("#379683"));
		...
		x.setForeground(Color.decode("#edf5e1"));
		...
		min.setForeground(Color.decode("#edf5e1"));
		...
		lgn.setForeground(Color.decode("#edf5e1"));
		...
		login.setBackground(Color.decode("#edf5e1"));
		login.setForeground(Color.decode("#05386b"));
		frame.add(login);
