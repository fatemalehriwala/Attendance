...
public class EditAttendance {
	...
	public void editView() throws SQLException {
		...
		dt.setForeground(Color.decode("#edf5e1"));
		frame.add(dt);
		JTextField dtbox= new JTextField();
		dtbox.setBounds(100, 60, 150, 25);
		dtbox.setBackground(Color.decode("#edf5e1"));
		dtbox.setFont(text);
		dtbox.setForeground(Color.decode("#05386b"));
...
//		JComboBox clss= new JComboBox(classEt());
		...
		view.setFont(btn);
		view.setBackground(Color.decode("#edf5e1"));
		view.setForeground(Color.decode("#05386b"));
		frame.add(view);
		...
		ab.setFont(btn);
		ab.setBackground(Color.decode("#edf5e1"));
		ab.setForeground(Color.decode("#05386b"));
		frame.add(ab);
		...
		pre.setFont(btn);
		pre.setBackground(Color.decode("#edf5e1"));
		pre.setForeground(Color.decode("#05386b"));
		frame.add(pre);
		...
		sbmt.setFont(btn);
		sbmt.setBackground(Color.decode("#edf5e1"));
		sbmt.setForeground(Color.decode("#05386b"));
		frame.add(sbmt);
		...
		del.setFont(btn);
		del.setBackground(Color.decode("#edf5e1"));
		del.setForeground(Color.decode("#05386b"));
		frame.add(del);
