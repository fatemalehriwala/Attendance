...
public class StudentView {
	...
	public void stView(int id) throws SQLException {
		...
		totalclass.setForeground(Color.decode("#edf5e1"));
		...
		ttbox.setForeground(Color.decode("#edf5e1"));
