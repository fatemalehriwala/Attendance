...
public class Students {
	...
	public void studentView() throws SQLException {
		...
		x.setForeground(Color.decode("#05386b"));
		...
		back.setForeground(Color.decode("#05386b"));
		...
		panel.setBackground(Color.decode("#edf5e1"));
		frame.add(panel);
		//---------------------------------------------------------
		...
		id.setForeground(Color.decode("#edf5e1"));
		frame.add(id);
		JTextField idbox= new JTextField();
		idbox.setBounds(60, 60, 50, 25);
		idbox.setBackground(Color.decode("#edf5e1"));
		idbox.setFont(text);
		idbox.setForeground(Color.decode("#05386b"));
		...
		classes.setForeground(Color.decode("#edf5e1"));
		frame.add(classes);
		...
		user.setForeground(Color.decode("#edf5e1"));
		frame.add(user);
		JTextField username= new JTextField();
		username.setBounds(25, 160, 400, 35);
		username.setBackground(Color.decode("#edf5e1"));
		username.setFont(text);
		username.setForeground(Color.decode("#05386b"));
		...
		nm.setForeground(Color.decode("#edf5e1"));
		frame.add(nm);
		JTextField name= new JTextField();
		name.setBounds(25, 270, 400, 35);
		name.setBackground(Color.decode("#edf5e1"));
		name.setFont(text);
		name.setForeground(Color.decode("#05386b"));
		...
		pass.setForeground(Color.decode("#edf5e1"));
		frame.add(pass);
		JTextField password= new JTextField();
		password.setBounds(25, 380, 400, 35);
		password.setBackground(Color.decode("#edf5e1"));
		password.setFont(text);
		password.setForeground(Color.decode("#05386b"));
		...
		save.setFont(btn);
		save.setBackground(Color.decode("#edf5e1"));
		save.setForeground(Color.decode("#05386b"));
		...
		edit.setFont(btn);
		edit.setEnabled(false);
		edit.setBackground(Color.decode("#edf5e1"));
		edit.setForeground(Color.decode("#05386b"));
		frame.add(edit);
		...
		add.setFont(btn);
		add.setBackground(Color.decode("#edf5e1"));
		add.setForeground(Color.decode("#05386b"));
		frame.add(add);
		...
		delete.setFont(btn);
		delete.setBackground(Color.decode("#edf5e1"));
		delete.setForeground(Color.decode("#05386b"));
		delete.setEnabled(false);
		frame.add(delete);
		...
		frame.getContentPane().setBackground(Color.decode("#05386b"));
