...
public class Home{
	...
	public void homeView(int id) throws SQLException {
		...
		min.setForeground(Color.decode("#05386b"));
		...
		welcome.setForeground(Color.decode("#edf5e1"));
		...
		students.setBackground(Color.decode("#edf5e1"));
		students.setForeground(Color.decode("#05386b"));
		frame.add(students);
		...
		addattendance.setBackground(Color.decode("#edf5e1"));
		addattendance.setForeground(Color.decode("#05386b"));
		...
		editattendance.setBackground(Color.decode("#edf5e1"));
		editattendance.setForeground(Color.decode("#05386b"));
		...
		teacher.setBackground(Color.decode("#edf5e1"));
		teacher.setForeground(Color.decode("#05386b"));
		frame.add(teacher);
		...
		admin.setBackground(Color.decode("#edf5e1"));
		admin.setForeground(Color.decode("#05386b"));
		frame.add(admin);
		...
		classes.setBackground(Color.decode("#edf5e1"));
		classes.setForeground(Color.decode("#05386b"));
		frame.add(classes);
